import svgPaths from "./svg-clq27tba6m";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 2">
      <div className="flex flex-col font-['Lexend:Bold','Noto_Sans_Symbols:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#1c180d] text-[20px] tracking-[-0.5px] whitespace-nowrap">
...
function Container113() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-[35px] pt-[20px] relative w-full">
        <div className="flex flex-col font-['Lexend:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#9ca3af] text-[12px] tracking-[0.6px] uppercase w-[201px]">
          <p className="leading-[16px]">Select Date Types TO ADD</p>
        </div>
      </div>
...
function BackgroundBorderShadow2() {
  return (
    <div className="bg-white h-[353px] relative rounded-[12px] shrink-0 w-[960px]" data-name="Background+Border+Shadow">
      <div className="content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
...
function Main1() {
  return (
    <div className="absolute inset-[73px_0_62px_0] overflow-clip" data-name="Main">
      <Container87 />
      <div className="absolute h-0 left-[235px] top-[327px] w-[958px]">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 958 1">
            <path d="M0 0.5H958" id="Line 1" stroke="var(--stroke-0, #E8E2CE)" />
          </svg>
        </div>
      </div>
    </div>
