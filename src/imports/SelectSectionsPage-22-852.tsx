import svgPaths from "./svg-s4dupxi3hl";
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white h-[292px] relative rounded-[12px] shrink-0 w-full" data-name="Background+Border+Shadow">
...
export default function SelectSectionsPage() {
  return (
    <div className="bg-white overflow-clip relative rounded-[32px] size-full" data-name="Select Sections Page">
      <Frame />
      <div className="absolute flex h-[12px] items-center justify-center left-[486px] top-[527px] w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          ...
          <div className="h-0 relative w-[12px]">
            <div className="absolute inset-[-7.36px_-8.33%_-7.36px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 14.7279">
                <path d={svgPaths.p1e3fa6c0} fill="var(--stroke-0, #9CA3AF)" id="Arrow 1" />
              </svg>
            </div>
          </div>
        </div>
